...
-- Preserve max reputation gates so quests can disappear once a player reaches
-- the upper reputation threshold.
ALTER TABLE `quests`
ADD COLUMN IF NOT EXISTS `RequiredMaxRepFaction` int(10) unsigned NOT NULL DEFAULT 0
AFTER `RequiredRepValue`;

ALTER TABLE `quests`
ADD COLUMN IF NOT EXISTS `RequiredMaxRepValue` int(10) unsigned NOT NULL DEFAULT 0
AFTER `RequiredMaxRepFaction`;

-- Preserve reputation-as-objective requirements so quests can complete from
-- reputation standing progress.
ALTER TABLE `quests`
ADD COLUMN IF NOT EXISTS `RepObjectiveFaction` int(10) unsigned NOT NULL DEFAULT 0
AFTER `RequiredMaxRepValue`;

ALTER TABLE `quests`
ADD COLUMN IF NOT EXISTS `RepObjectiveValue` int(10) NOT NULL DEFAULT 0
AFTER `RepObjectiveFaction`;

-- All five quest reputation reward slots to complete data
ALTER TABLE `quests`
ADD COLUMN IF NOT EXISTS `RewRepFaction3` int(10) unsigned NOT NULL DEFAULT 0
AFTER `RewRepFaction2`;

ALTER TABLE `quests`
ADD COLUMN IF NOT EXISTS `RewRepFaction4` int(10) unsigned NOT NULL DEFAULT 0
AFTER `RewRepFaction3`;

ALTER TABLE `quests`
ADD COLUMN IF NOT EXISTS `RewRepFaction5` int(10) unsigned NOT NULL DEFAULT 0
AFTER `RewRepFaction4`;

ALTER TABLE `quests`
ADD COLUMN IF NOT EXISTS `RewRepValue3` int(10) NOT NULL DEFAULT 0
AFTER `RewRepValue2`;

ALTER TABLE `quests`
ADD COLUMN IF NOT EXISTS `RewRepValue4` int(10) NOT NULL DEFAULT 0
AFTER `RewRepValue3`;
...
-- Backfill max reputation availability gates from source quest_template data.
-- A quest becomes unavailable when player standing with RequiredMaxRepFaction
-- is greater than or equal to RequiredMaxRepValue.
UPDATE `quests`
SET
  `RequiredMaxRepFaction` = CASE `entry`
    WHEN 1036 THEN 21
    WHEN 4621 THEN 21
    WHEN 6701 THEN 349
    WHEN 7736 THEN 59
    ...
    WHEN 10827 THEN 932
    WHEN 10828 THEN 932
    WHEN 10917 THEN 1011
    WHEN 10918 THEN 1011
    WHEN 10981 THEN 933
    WHEN 11548 THEN 1077
    ELSE `RequiredMaxRepFaction`
  END,
  `RequiredMaxRepValue` = CASE `entry`
    WHEN 1036 THEN 1
    WHEN 4621 THEN 1
    WHEN 6701 THEN 3000
    WHEN 7736 THEN 3000
    ...
    WHEN 8242 THEN 3000
    WHEN 8302 THEN 0
    WHEN 9121 THEN 20999
    WHEN 9122 THEN 41999
    WHEN 9221 THEN 8999
    WHEN 9222 THEN 8999
    WHEN 9223 THEN 20999
    WHEN 9224 THEN 20999
    WHEN 9225 THEN 41999
    WHEN 9226 THEN 41999
    WHEN 9259 THEN 0
    WHEN 9266 THEN 0
    WHEN 9267 THEN 0
    WHEN 9268 THEN 0
    ...
    WHEN 9808 THEN 3000
    WHEN 9809 THEN 3000
    WHEN 9875 THEN 20999
    WHEN 9882 THEN 3000
    WHEN 9883 THEN 3000
    WHEN 9884 THEN 21000
    WHEN 9885 THEN 42000
    WHEN 9886 THEN 9000
    WHEN 9914 THEN 2999
    WHEN 9915 THEN 2999
    WHEN 10017 THEN 1
    ...
    WHEN 10024 THEN 1
    WHEN 10025 THEN 1
    WHEN 10106 THEN 41999
    WHEN 10110 THEN 41999
    WHEN 10325 THEN 8999
    WHEN 10326 THEN 8999
    WHEN 10327 THEN 8999
    WHEN 10412 THEN 8999
    WHEN 10414 THEN 8999
    WHEN 10415 THEN 8999
    WHEN 10653 THEN 41999
    WHEN 10654 THEN 41999
    WHEN 10655 THEN 41999
    WHEN 10656 THEN 41999
    WHEN 10658 THEN 41999
    WHEN 10659 THEN 41999
    WHEN 10822 THEN 41999
    WHEN 10823 THEN 41999
    WHEN 10824 THEN 41999
    WHEN 10826 THEN 41999
    WHEN 10827 THEN 41999
    WHEN 10828 THEN 41999
    WHEN 10917 THEN 8999
    WHEN 10918 THEN 8999
    WHEN 10981 THEN 42000
    WHEN 11548 THEN 42000
    ELSE `RequiredMaxRepValue`
  END
WHERE `entry` IN (
  1036, 4621, 6701, 7736, 7737, 7881, 7882, 7883, 7884,
  7885, 7889, 7890, 7891, 7892, 7893, 7894, 7895, 7896,
  7897, 7898, 7899, 7900, 7901, 7902, 7903, 8222, 8241,
  8242, 8302, 9121, 9122, 9221, 9222, 9223, 9224, 9225,
  9226, 9259, 9266, 9267, 9268, 9739, 9742, 9743, 9744,
  9784, 9802, 9808, 9809, 9875, 9882, 9883, 9884, 9885,
  9886, 9914, 9915, 10017, 10019, 10024, 10025, 10106,
  10110, 10325, 10326, 10327, 10412, 10414, 10415, 10653,
  10654, 10655, 10656, 10658, 10659, 10822, 10823, 10824,
  10826, 10827, 10828, 10917, 10918, 10981, 11548
)
AND `RequiredMaxRepFaction` = 0
AND `RequiredMaxRepValue` = 0;

-- Backfill quest reputation reward slots 3-5
CREATE TEMPORARY TABLE `_quest_rew_rep_slots_3_5` (
  `entry` int(10) unsigned NOT NULL,
...
INSERT INTO `_quest_rew_rep_slots_3_5`
(`entry`, `RewRepFaction3`, `RewRepFaction4`, `RewRepFaction5`, `RewRepValue3`, `RewRepValue4`, `RewRepValue5`)
VALUES
(32,76,911,81,350,350,350),
(162,930,54,47,350,350,350),
(253,54,47,72,500,500,500),
(281,469,0,0,10,0,0),
(455,47,0,0,150,0,0),
(498,81,0,0,150,0,0),
(834,76,0,0,250,0,0),
(835,76,0,0,250,0,0),
(891,76,911,81,75,75,75),
(1081,54,47,72,500,500,500),
(1180,470,0,0,25,0,0),
(1394,911,81,68,500,500,500),
(1468,54,47,72,10,10,10),
(1658,54,69,0,150,150,0),
(3921,76,911,81,25,25,25),
(3922,76,911,81,75,75,75),
(3923,76,911,81,10,10,10),
(3924,76,911,81,150,150,150),
(4004,911,81,68,500,500,500),
(4261,930,0,0,150,0,0),
(4266,54,47,72,500,500,500),
(4267,930,54,47,350,350,350),
(4510,54,47,72,500,500,500),
(4511,911,81,68,500,500,500),
(4726,369,470,0,250,250,0),
(4735,369,470,0,350,350,0),
(4902,54,47,72,250,250,250),
(4974,911,81,68,500,500,500),
(5096,530,76,911,75,75,75),
(5245,54,47,72,25,25,25),
(5246,54,47,72,25,25,25),
(5247,54,47,72,25,25,25),
(5248,54,47,72,25,25,25),
(5252,54,47,72,25,25,25),
(5253,54,47,72,250,250,250),
(5518,369,470,0,250,250,0),
(5519,369,470,0,50,50,0),
(6804,911,81,68,250,250,250),
(6962,369,470,0,25,25,0),
(7003,369,470,0,350,350,0),
(7025,369,470,0,25,25,0),
(7488,54,47,72,350,350,350),
(7489,911,81,68,350,350,350),
(7637,930,0,0,150,0,0),
(7639,69,930,0,25,25,0),
(7640,72,930,0,250,75,0),
(7642,469,0,0,75,0,0),
(7667,911,81,68,350,350,350),
(7721,369,470,0,350,350,0),
(7725,369,470,0,25,25,0),
(7726,369,470,0,25,25,0),
(7730,911,81,68,250,250,250),
(7731,911,81,68,350,350,350),
(7732,911,81,68,75,75,75),
(7781,47,72,0,250,500,0),
(7782,47,72,0,250,500,0),
(8149,54,47,72,250,250,250),
(8150,911,81,68,250,250,250),
(8258,911,81,68,500,500,500),
(8311,54,47,72,150,150,150),
(8312,911,81,68,150,150,150),
(8322,911,81,68,25,25,25),
(8409,911,81,68,150,150,150),
(9039,509,0,0,250,0,0),
(9259,21,369,577,500,250,250),
(9266,21,369,577,250,250,500),
(9268,21,369,577,250,500,250),
(10016,54,47,72,250,250,250),
(10017,0,0,935,0,0,125),
(10020,0,0,935,0,0,175),
(10021,0,0,935,0,0,125),
(10024,0,0,935,0,0,125),
(10169,0,0,935,0,0,37),
(10189,0,0,935,0,0,125),
(10193,0,0,935,0,0,125),
(10194,0,0,935,0,0,5),
(10197,0,0,935,0,0,125),
(10198,0,0,935,0,0,75),
(10202,0,0,935,0,0,37),
(10204,0,0,935,0,0,125),
(10241,0,0,935,0,0,125),
(10243,0,0,935,0,0,37),
(10245,0,0,935,0,0,37),
(10246,0,0,935,0,0,125),
(10299,0,0,935,0,0,125),
(10313,0,0,935,0,0,125),
(10321,0,0,935,0,0,125),
(10322,0,0,935,0,0,125),
(10323,0,0,935,0,0,125),
(10325,0,0,935,0,0,125),
(10328,0,0,935,0,0,125),
(10329,0,0,935,0,0,125),
(10330,0,0,935,0,0,125),
(10338,0,0,935,0,0,125),
(10341,0,0,935,0,0,125),
(10365,0,0,935,0,0,125),
(10380,0,0,935,0,0,125),
(10381,0,0,935,0,0,75),
(10407,0,0,935,0,0,175),
(10409,0,0,935,0,0,500),
(10410,0,0,935,0,0,75),
(10412,0,0,935,0,0,125),
(10416,0,0,935,0,0,175),
(10420,0,0,935,0,0,175),
(10431,0,0,935,0,0,12),
(10432,0,0,935,0,0,125),
(10507,0,0,935,0,0,500),
(10508,0,0,935,0,0,175),
(10509,0,0,935,0,0,75),
(10553,0,0,935,0,0,5),
(10554,0,0,935,0,0,5),
(10568,0,0,935,0,0,125),
(10571,0,0,935,0,0,125),
(10574,0,0,935,0,0,125),
(10575,0,0,935,0,0,37),
(10587,0,0,935,0,0,125),
(10619,0,0,935,0,0,125),
(10637,0,0,935,0,0,125),
(10640,0,0,935,0,0,37),
(10650,0,0,935,0,0,37),
(10651,0,0,935,0,0,500),
(10652,0,0,935,0,0,5),
(10653,0,0,935,0,0,125),
(10656,0,0,935,0,0,125),
(10683,0,0,935,0,0,125),
(10684,0,0,935,0,0,125),
(10685,0,0,935,0,0,125),
(10686,0,0,935,0,0,37),
(10687,0,0,935,0,0,125),
(10688,0,0,935,0,0,125),
(10689,0,0,935,0,0,37),
(10691,0,0,935,0,0,37),
(10692,0,0,935,0,0,500),
(10807,0,0,935,0,0,125),
(10816,0,0,935,0,0,125),
(10817,0,0,935,0,0,125),
(10824,0,0,935,0,0,125),
(10826,0,0,935,0,0,125),
(11038,0,0,935,0,0,5),
(11211,911,81,68,350,350,350);

UPDATE `quests` q
JOIN `_quest_rew_rep_slots_3_5` src
  ON src.`entry` = q.`entry`
SET
  q.`RewRepFaction3` = src.`RewRepFaction3`,
  q.`RewRepFaction4` = src.`RewRepFaction4`,
  q.`RewRepFaction5` = src.`RewRepFaction5`,
  q.`RewRepValue3` = src.`RewRepValue3`,
  q.`RewRepValue4` = src.`RewRepValue4`,
  q.`RewRepValue5` = src.`RewRepValue5`
WHERE q.`RewRepFaction3` = 0
  AND q.`RewRepFaction4` = 0
  AND q.`RewRepFaction5` = 0
  AND q.`RewRepValue3` = 0
  AND q.`RewRepValue4` = 0
  AND q.`RewRepValue5` = 0;

DROP TEMPORARY TABLE `_quest_rew_rep_slots_3_5`;

-- Backfill reputation objective requirements 
-- These make quests complete only after reaching the required
-- standing with the listed faction.
CREATE TEMPORARY TABLE `_quest_rep_objectives` (
  `entry` int(10) unsigned NOT NULL,
...
INSERT INTO `_quest_rep_objectives`
(`entry`, `RepObjectiveFaction`, `RepObjectiveValue`)
VALUES
(1036, 87, 3000),
(1367, 93, 3000),
(1368, 92, 3000),
...
UPDATE `quests` q
JOIN `_quest_rep_objectives` src
  ON src.`entry` = q.`entry`
SET
  q.`RepObjectiveFaction` = src.`RepObjectiveFaction`,
  q.`RepObjectiveValue` = src.`RepObjectiveValue`
