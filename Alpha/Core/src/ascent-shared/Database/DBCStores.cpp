...
SERVER_DECL DBCStorage<ItemEntry> dbcItems;
...
const char* WorldSafeLocsFormat = "nifffsxxxxxxxxxxxxxxxx";
...
bool LoadDBCs()
{
	LOAD_DBC("DBC/WorldSafeLocs.dbc", WorldSafeLocsFormat, true, dbcWorldSafeLocs, true);
	LOAD_DBC("DBC/Item.dbc", ItemsFormat, true, dbcItems, true);
