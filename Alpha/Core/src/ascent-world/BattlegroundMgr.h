...
#define AV_ASSAULTED_STONEHEART_GRAVE_HORDE   0x517 // Horde assaulting Stonehearth Graveyard
#define AV_ASSAULTED_STONEHEART_GRAVE_ALLIANCE 0x518 // Alliance assaulting Stonehearth Graveyard
#define AV_ASSAULTED_STORMPIKE_AID_STATION_HORDE 0x52F
#define AV_ASSAULTED_STORMPIKE_AID_STATION_ALLIANCE 0x52E
#define AV_ASSAULTED_FROSTWOLF_RELIEF_HUT_HORDE 0x534
#define AV_ASSAULTED_FROSTWOLF_RELIEF_HUT_ALLIANCE 0x533
#define AV_ASSAULTED_STORMPIKE_GRAVE_HORDE 0x538
#define AV_ASSAULTED_STORMPIKE_GRAVE_ALLIANCE 0x537
#define AV_ASSAULTED_FROSTWOLF_GRAVE_HORDE 0x53C
#define AV_ASSAULTED_FROSTWOLF_GRAVE_ALLIANCE 0x53B
#define AV_ASSAULTED_ICEBLOOD_GRAVE_HORDE 0x545
#define AV_ASSAULTED_ICEBLOOD_GRAVE_ALLIANCE 0x544
#define AV_ASSAULTED_SNOWFALL_GRAVE_HORDE 0x540
#define AV_ASSAULTED_SNOWFALL_GRAVE_ALLIANCE 0x53F

#define AV_DUBALDAR_SOUTH_BUNKER_DESTROYED 0x55A
#define AV_DUBALDAR_NORTH_BUNKER_DESTROYED 0x55B
#define AV_ICEWING_BUNKER_DESTROYED 0x55C
#define AV_STONEHEARTH_BUNKER_DESTROYED 0x55D
#define AV_DUBALDAR_SOUTH_BUNKER_ASSAULTED 0x562
#define AV_DUBALDAR_NORTH_BUNKER_ASSAULTED 0x563
#define AV_ICEWING_BUNKER_ASSAULTED 0x564
#define AV_STONEHEARTH_BUNKER_ASSAULTED 0x565
#define AV_WEST_FROSTWOLF_TOWER_DESTROYED 0x555
#define AV_EAST_FROSTWOLF_TOWER_DESTROYED 0x556
#define AV_TOWER_POINT_DESTROYED 0x557
#define AV_ICEBLOOD_TOWER_DESTROYED 0x558
#define AV_WEST_FROSTWOLF_TOWER_ASSAULTED 0x56B
#define AV_EAST_FROSTWOLF_TOWER_ASSAULTED 0x56C
#define AV_TOWER_POINT_ASSAULTED 0x56D
#define AV_ICEBLOOD_TOWER_ASSAULTED 0x56E
...
#define AV_CONTROLED_STORMPIKE_GRAVE_HORDE 0x536 //1 -> horde controled
...
#define AV_CONTROLED_STONEHEART_GRAVE_HORDE 0x515 //1 -> horde controled
...
public:
	...
	/* Packet Handlers */
	void HandleBattlegroundListPacket(WorldSession * m_session, uint32 BattlegroundType, uint64 battlemasterGuid, uint32 battlemasterEntry);
