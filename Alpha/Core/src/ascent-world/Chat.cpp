...
void CommandTableStorage::Init()
{
	...
	{
		{ "list",		'q', &ChatHandler::HandleRecallListCommand,	   "List teleport locations",		  NULL, 0, 0, 0},
		{ "to", 		'q', &ChatHandler::HandleRecallGoCommand,		 "Port to teleport location",	  NULL, 0, 0, 0},
		{ "add",   	    'q', &ChatHandler::HandleRecallAddCommand,		"Add teleport location",			NULL, 0, 0, 0},
		{ "del",		'q', &ChatHandler::HandleRecallDelCommand,		"Remove a teleport location",	   NULL, 0, 0, 0},
		{ "player",     'm', &ChatHandler::HandleRecallPortPlayerCommand, "Teport a player", NULL, 0, 0, 0 },
		{ NULL,		   0,  NULL,										"",							   NULL, 0, 0, 0},
	};
	...
	static ChatCommand commandTable[] = {
		...
		{ "teleport",		'q', NULL,									 "",				 recallCommandTable, 0, 0, 0},
