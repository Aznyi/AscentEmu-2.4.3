...
private:
	...
	unordered_map<uint32, list<QuestAssociation *>* > m_quest_associations;
...
template<> ASCENT_INLINE unordered_map<uint32, list<QuestRelation *>* >& QuestMgr::_GetList<Creature>()
	{return m_npc_quests;}
template<> ASCENT_INLINE unordered_map<uint32, list<QuestRelation *>* >& QuestMgr::_GetList<GameObject>()
	{return m_obj_quests;}
template<> ASCENT_INLINE unordered_map<uint32, list<QuestRelation *>* >& QuestMgr::_GetList<Item>()
	{return m_itm_quests;}
