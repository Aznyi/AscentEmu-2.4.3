...
/* Hashmap typedefs */
typedef unordered_map<uint32, exp_create_creature_ai> CreatureCreateMap;
typedef unordered_map<uint32, exp_create_gameobject_ai> GameObjectCreateMap;
typedef unordered_map<uint32, exp_handle_dummy_aura> HandleDummyAuraMap;
typedef unordered_map<uint32, exp_handle_dummy_spell> HandleDummySpellMap;
